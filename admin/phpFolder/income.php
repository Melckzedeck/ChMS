...
//       $expAmountErr = "Error branch code is required";
//      }
//      else{
//       $expAmount  = validate( $_POST["expAmount"]);
...
?>
    ...
    <div class="form-container">
    <p><b>Manage: </b> Income Information</p>
          
    <!-- <p class="branch">Manage Income</p> <br> -->
...
<div class="print-container">
        ...
        <div style="background: rgb(10, 10, 41); border-radius: 8px;" class="total income">
          ...
          <?php
               ...
               if(mysqli_num_rows($result) > 0){
                ...
                echo '<a href="expenses.php">   <button id="save-btn" class="btn" name="save">View Details</button> </a>';
                
          ?>
     
        </div>

        <div style="background: orangered; border-radius: 8px;"; class="current income">
          Current Budget <br> <br>
             <?php
             $current_balance = ($total_deposit - $total_expense);
             echo "<h3>".$current_balance. "</h3>";
             ?>
        </div>
      </div>
      ...
      <!-- ============= fetching data from table deposit and expenses ==============  -->
       <!-- form deposit  -->
